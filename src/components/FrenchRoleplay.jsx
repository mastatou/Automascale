...
export default function FrenchRoleplay() {
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <h2 className="text-4xl font-bold mb-16 text-center">3ème Use Case - French Roleplay</h2>
        ...
        <div className="max-w-4xl mx-auto mb-16 group relative bg-gray-900/50 backdrop-blur-sm p-8 rounded-2xl
          ...
          <div className="flex items-start gap-6 relative">
            <img 
              src="https://i.imgur.com/eUMM9J4.png" 
              alt="François Favier" 
              className="w-16 h-16 rounded-full object-cover border-2 border-[#21874E]"
            />
            <div>
              <h3 className="text-xl font-bold">François Favier</h3>
              <p className="text-gray-400 mb-4">Directeur de French-Roleplay</p>
              <p className="text-gray-300 text-lg leading-relaxed italic">
                "Grâce à notre bot Discord automatisé, la plupart des questions des joueurs sont désormais traitées instantanément : règles du serveur, tutoriels, problèmes courants... tout est couvert. Mon équipe n'a plus besoin de fournir un support constant et peut se concentrer sur l'amélioration du gameplay. Grâce à cette automatisation, la satisfaction et la fidélisation des joueurs ont considérablement augmenté. Une solution d'IA essentielle pour augmenter la productivité et l'efficacité !"
              </p>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="relative group">
            <a href="https://holistic-nitrogen-e9e.notion.site/Fran-ois-Favier-19a9f466a92d80e5a788e597a07cb4dc?pvs=4" 
               target="_blank" 
               rel="noopener noreferrer"
               className="block relative overflow-hidden rounded-2xl">
              <img 
                src="https://i.imgur.com/L1f0COJ.png" 
                alt="French Roleplay Case Study" 
